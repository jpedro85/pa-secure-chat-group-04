...
class CustomCertificateTest {
    ...
    void setUp() {
        ...
        certificate = new CertificateGenerator()
                .withPublicKey(publicKeyMock)
                .issuedBy("Test Issuer")
                .forSubject("Test Subject")
                .validFrom(validFrom)
                .validTo(validTo)
                .generate();
    ...
    void testIsValidWhenCurrentDateIsWithinRange() {
        assertTrue(certificate.isValid(),
                "Certificate should be valid when the current date is within the valid range");
    }
    ...
    void testIsValidWhenCurrentDateIsOutOfRange() {
        ...
        assertFalse(certificate.isValid(),
                "Certificate should not be valid when the current date is out of the valid range");
    }
}
